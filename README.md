...
- Battery powered
- LCD display 20x4
- Laser ranging sensor (VL53L1X TOF)
- Laser diode to mark throw spot
- 9g Servo
...
<p align="center">
    ...
    <img src="https://github.com/itCarl/DartTool/blob/development/assets/dart_tool_logo_backgrounds.svg" width="400">
</p>
...
1. Fork the Project locally via git clone `https://github.com/itCarl/DartTool.git` (replacing `itCarl` with your GitHub Username) and work on your local copy
2. Add the upstream repository via git remote add upstream `https://github.com/itCarl/DartTool.git`
3. Ensure you are on the development branch via `git checkout development`
...
1. Return to the development branch via `git checkout development`
2. Ensure your development branch is up-to-date with the latest changes via `git pull upstream development`
...
1. Clone this repo
    ...
    ```sh
    git clone https://github.com/itCarl/development.git
    ```
